...
<body>
  ...
  <%@include file="Encabezado2.jsp"%>
    <div id="site_content">
      ...
      <div class="content">
          <h3>Reservar Accesorios</h3>         
          <form action="enviar" method="POST">
              <table border="0">
                  <tbody>
                      <tr>
                          <td><font color="red"></font>Seleccione Accesorio: </td>
                          <td><select name="listaArmas">
                                  <option></option>
                                  <option>Chalecos Anti-balas</option>
                                  <option>Gorros Navarones</option>
                                  <option>Fundas para psitola</option>
                      ...
                      <tr>
                          ...
                          <td><input type="button" value="Cancelar" onclick="location.href='index.jsp'" /></td>
                      </tr>
                  </tbody>
              </table>
          </form>
