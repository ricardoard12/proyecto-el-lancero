  ...
  <div id="main">
    ...
    <div id="site_content">
      ...
      <div class="content">
        ...
        <p>Estimado cliente le informamos que hemos recibido sus comentarios.</p>
        <p>Uno de nuestros asesores le contactará.</p>
        <p>Para mayor información puede comunicarse al telefono 2222-0975</p>        
      </div>
    </div>
    <footer>
      El Lancero © 2013
